...
class PneumoniaQuestions extends StatefulWidget {
  ...
  @override
  State<PneumoniaQuestions> createState() => _PneumoniaQuestionsState();
}
                ...
                children: [
                  ...
                  Text(
                    LocalizationService.of(context).translate(
                        controller.pneumoniaQuestions[controller.currentPage].question
                    )!,
      ...
      child: TextButton(
        onPressed: () {
          setState(() {
            ...
            controller.currentPage].question] == 'Yes'){
              kPneumoniaYesAnswers.add(LocalizationService.of(context).translate(
                  controller.pneumoniaQuestions[controller.currentPage].question
              )!);}
